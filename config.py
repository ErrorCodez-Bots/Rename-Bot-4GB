...
START_TXT = os.environ.get(
    "START_TXT", 
    "<b><blockquote>ʜᴇʏ, {mention}! ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴛʜᴇ ᴍᴏꜱᴛ ᴀᴅᴠᴀɴᴄᴇᴅ ʀᴇɴᴀᴍᴇ ʙᴏᴛ!</blockquote></b>\n\n"
    "<b><blockquote>ᴡɪᴛʜ ᴍʏ ᴘᴏᴡᴇʀꜰᴜʟ ꜰᴇᴀᴛᴜʀᴇꜱ, ʏᴏᴜ ᴄᴀɴ:-\n"
    "ᴀᴜᴛᴏʀᴇɴᴀᴍᴇ ꜰɪʟᴇꜱ ᴡɪᴛʜ ᴄᴜꜱᴛᴏᴍ ꜰᴏʀᴍᴀᴛꜱ.-\n"
    "ᴀᴅᴅ ᴄᴀᴘᴛɪᴏɴꜱ ᴏʀ ꜱᴇʟᴇᴄᴛ ᴛʜᴜᴍʙɴᴀɪʟꜱ.-\n"
    "ᴘʀᴏᴄᴇꜱꜱ ꜰɪʟᴇꜱ ꜱᴇǫᴜᴇɴᴛɪᴀʟʟʏ ꜰᴏʀ ꜱᴍᴏᴏᴛʜ ᴡᴏʀᴋꜰʟᴏᴡ.</blockquote></b>\n\n"
    "<b><blockquote>🔷 ʀᴇᴀᴅʏ ᴛᴏ ʙᴇɢɪɴ? ᴊᴜꜱᴛ ꜱᴇɴᴅ ᴍᴇ ᴀɴʏ ꜰɪʟᴇ!\n"
    "🔷 ꜰᴏʀ ᴅᴇᴛᴀɪʟꜱ, ᴛᴀᴘ ᴛʜᴇ ʜᴇʟᴘ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ.</blockquote></b>"
)

HELP_TXT = os.environ.get(
    "HELP_TXT", 
    "<b>• ᴀᴠᴀɪʟᴀʙʟᴇ ᴄᴏᴍᴍᴀɴᴅꜱ</b>\n\n"
    "<b><blockquote>• <u>ᴛʜᴜᴍʙɴᴀɪʟ ꜱᴇᴛᴛɪɴɢꜱ</u>\n"
    "• ꜱᴇɴᴅ ᴀɴʏ ᴘʜᴏᴛᴏ ᴛᴏ ꜱᴇᴛ ɪᴛ ᴀꜱ ᴀ ᴄᴜꜱᴛᴏᴍ ᴛʜᴜᴍʙɴᴀɪʟ.\n"
    "• /vɪᴇᴡᴛʜᴜᴍʙ - ᴠɪᴇᴡ ʏᴏᴜʀ ᴄᴜʀʀᴇɴᴛ ᴛʜᴜᴍʙɴᴀɪʟ.\n"
    "• /ᴅᴇʟᴛʜᴜᴍʙ - ᴅᴇʟᴇᴛᴇ ʏᴏᴜʀ ᴄᴜʀʀᴇɴᴛ ᴛʜᴜᴍʙɴᴀɪʟ.\n\n"
    ...
    "• <u>ʀᴇɴᴀᴍɪɴɢ ᴍᴏᴅᴇꜱ</u>\n"
    "• /ʀᴇɴᴀᴍᴇ_ᴍᴏᴅᴇ - ꜱᴡɪᴛᴄʜ ʙᴇᴛᴡᴇᴇɴ ꜱɪɴɢʟᴇ ᴀɴᴅ ᴀᴜᴛᴏ ʀᴇɴᴀᴍᴇ.\n"
    "• /ꜰᴏʀᴍᴀᴛ - ꜱᴇᴛ ʏᴏᴜʀ ᴀᴜᴛᴏ-ʀᴇɴᴀᴍᴇ ꜰᴏʀᴍᴀᴛ.\n"
    "• /ᴍᴏᴅᴇ - ᴏᴘᴇɴ ᴛʜᴇ ʀᴇɴᴀᴍᴇ ᴍᴏᴅᴇ ᴍᴇɴᴜ.\n\n"
    "• <u>ᴘʀᴇꜰɪx & ꜱᴜꜰꜰɪx</u>\n"
    ...
    "• /ᴅᴏɴᴀᴛᴇ - ꜱᴜᴘᴘᴏʀᴛ ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴘᴇʀ.</blockquote></b>\n\n"
...
DONATE_TXT = os.environ.get(
    "DONATE_TXT",
    "<b><blockquote>🎰 ᴛʜᴀɴᴋꜱ ꜰᴏʀ ꜱʜᴏᴡɪɴɢ ɪɴᴛᴇʀᴇꜱᴛ ɪɴ ᴅᴏɴᴀᴛɪᴏɴ! 🍧</blockquote></b>\n\n"
    "<b><blockquote>ɪꜰ ʏᴏᴜ ʟɪᴋᴇ ᴍʏ ʙᴏᴛꜱ & ᴘʀᴏᴊᴇᴄᴛꜱ, ʏᴏᴜ ᴄᴀɴ\n"
    "🎁 ᴅᴏɴᴀᴛᴇ ᴜꜱ ᴀɴʏ ᴀᴍᴏᴜɴᴛ ꜰʀᴏᴍ 10 ʀꜱ ᴜᴘᴛᴏ ʏᴏᴜʀ ᴄʜᴏɪᴄᴇ. ʏᴏᴜʀ ꜱᴜᴘᴘᴏʀᴛ ʜᴇʟᴘꜱ ᴜꜱ ᴋᴇᴇᴘ ᴛʜᴇ ꜱᴇʀᴠᴇʀꜱ ʀᴜɴɴɪɴɢ ᴀɴᴅ ᴀᴅᴅ ᴍᴏʀᴇ ᴀᴡᴇꜱᴏᴍᴇ ꜰᴇᴀᴛᴜʀᴇꜱ ꜰᴏʀ ᴇᴠᴇʀʏᴏɴᴇ ᴛᴏ ᴇɴᴊᴏʏ! ❤️</blockquote></b>\n\n"
